...
words = ["apple", "banana", "orange", "grape", "strawberry", "kiwi", "watermelon", "pineapple", "mango", "blueberry",
...
words1 = [
    "Verdant", "Verve", "Vivacious", "Whimsical", "Winsome", "Xanadu", "Xenial", "Xylophone", "Zany", "Zephyr",
    "Adventure", "Beacon", "Cascade", "Dream", "Ethereal", "Fantasy", "Glisten", "Harmony", "Infinite", "Journey",
    "Luminous", "Miracle", "Nirvana", "Ocean", "Paradise", "Quest", "Radiance", "Serene", "Tranquil", "Unicorn",
    "Velvet", "Wanderlust", "Zenith", "Aura", "Blossom", "Calm", "Divine", "Enchantment", "Felicity", "Grace",
    "Heavenly", "Inspire", "Jubilant", "Kaleidoscope", "Lullaby", "Majestic", "Noble", "Orchid", "Paragon", "Quintessence",
    "Radiant", "Serenity", "Talisman", "Uplift", "Vivid", "Whisper", "Xanadu", "Yearning", "Zest", "Abundance"
]
word_lists = [words1, words2, words3, words4]

# Loop through the list of words
for _ in range(35):  # Repeat the search process 10 times
